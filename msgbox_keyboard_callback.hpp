...
*/
#ifndef MSGBOXKEYBOARDCALLBACK
#define MSGBOXKEYBOARDCALLBACK
...
/*
  Handle the callback of a keyboard completition for msgbox
*/
class MsgboxKeyboardCallback : public KeyboardCallback
{
    public:

        ~MsgboxKeyboardCallback();
        MsgboxKeyboardCallback();
