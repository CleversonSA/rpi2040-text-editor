...
*/
#ifndef TEXTVIEWKEYBOARDCALLBACK
#define TEXTVIEWKEYBOARDCALLBACK
...
/*
  Handle the callback of a keyboard completition for text view
*/
class TextViewKeyboardCallback : public KeyboardCallback
{
    public:

        ~TextViewKeyboardCallback();
        TextViewKeyboardCallback();
    ...
    private:
        ...
        TextViewEngine  *_textViewEngine;
};
